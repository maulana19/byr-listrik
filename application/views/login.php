              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h2 text-gray-900 mb-5"><span class="fa fa-user"></span>         Halaman Login</h1>
                        <?php
    // Cek apakah terdapat session nama message
                             if (isset($error)) {echo $error;};?>
                  </div>
                  <form method="post" action="<?php echo base_url() ?>index.php/login" class="user">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="password" placeholder="Masukan Password Disini !!!"  name="password">
