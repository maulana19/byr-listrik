    ...
    <div class="sidebar" data-color="blue" data-image="<?php echo base_url('assets/img/sidebar-5.jpg') ?>">
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="<?php echo base_url() ?>index.php/admin/dashboard/data_pelanggan/">
                ...
                <li>
                    <a href="<?php echo base_url() ?>index.php/admin/dashboard/logout/">
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Halaman daftar riwayat Pembayaran listrik</p>
                                    ...
                                    <?php echo form_open('transaksi/cari') ?>
                                        <form class="" method="post">
                                            ...
                                            <div class="col-md-2">  
                                                ...
                                                <a  href="<?php echo base_url() ?>index.php/transaksi"><button class="btn btn-md btn-primary btn-fill" title="refresh"> <span class="pe-7s-refresh"></span></button></a>
                                            </div>
                                        </form>
                                        <?php echo form_close() ?>
