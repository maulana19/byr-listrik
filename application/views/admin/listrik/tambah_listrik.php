                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
                            	<?php echo form_open('listrik/simpan') ?>
                                <form method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
											<label>Kode Listrik(Otomatis)</label>
												<input type="text" class="form-control" name="kd_daya" readonly="readonly" value="<?php echo 'STR0'.time() ?>" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                      		<label for="daya">Besar Daya Listrik (Kwh)</label>
												<input class="form-control" type="number" name="daya">
                                            </div>
                                        </div>
