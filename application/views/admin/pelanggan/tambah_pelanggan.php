                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
												<label for="">ID Pelanggan (Otomatis)</label>
												<input type="text" class="form-control" name="kode_pelanggan" readonly="readonly" value="<?php echo 'PLG0'.time() ?>" >
											</div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
												...
												<input type="text" class="form-control" name="nama" required="required" placeholder="Masukan Nama Pelanggan">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
												...
												<input type="text" class="form-control" name="alamat" required="required" placeholder="Masukan Alamat Pelanggan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
												...
												<input class="form-control" type="number" name="telepon" required="required" placeholder="Masukan Nomor Telepon Pelanggan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <select name="daya" id="daya" class="form-control">
                                                <?php 
                                                   $daya_id = @intval($_GET['daya']);
                                                     foreach ($data_listrik as $listrik) {
                                                      if($daya_id == $listrik->id)
                                                         {
                                                           $harga = $listrik;
                                                         ?>
