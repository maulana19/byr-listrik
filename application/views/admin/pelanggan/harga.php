                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <?php 
                                // print_r($data_listrik);die();
                                 ?>
                                <form method="get" action="<?php echo base_url('index.php/pelanggan/tambah') ?>">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                            <label>Paket Tegangan Listrik</label>
                                            <select name="daya" id="daya" class="form-control">
                                                <option selected disabled="disabled"class="form-control">Pilihan</option>
                                                <?php 
                                    ...
                                    <a href=""><button type="submit" class="btn btn-info btn-fill pull-left">Prosess</button></a>
